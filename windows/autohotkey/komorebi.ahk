...
<#+n::
;Run, python C:\Users\ASUS\.local\share\yasb\src\main.py, , Hide
Run, nircmd.exe win trans class Shell_TrayWnd 256, , Hide
return

; restore task bar
<#+m::
;Run, python C:\Users\ASUS\.local\share\yasb\src\main.py, , Hide
Run, nircmd.exe win trans class Shell_TrayWnd 255, , Hide
return
...
; Flip horizontally, Win + shift h
<#+h::
Run, komorebic.exe flip-layout horizontal, , Hide
return

; Flip vertically, Win + shift v
<#+v::
